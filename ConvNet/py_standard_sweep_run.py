from efficient_training_neural_Nets.benchmark_training.py_lightning_datamodule import DataModule_lightning
from efficient_training_neural_Nets.benchmark_training.py_lightning_module import  lightning_module
...
parser.add_argument("--method", type=str, default="mtransfer")
...
run_experiment=Dataset_Trainer(config)
